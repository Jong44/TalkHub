    ...
    <CardLayout>
      <div className='flex flex-col items-center relative'>
        ...
        <div className='rounded-full w-20 h-20 bg-slate-50 -mt-10 relative'>
          {data.photoURL ? <Image src={data.photoURL} alt='profile' width={0} height={0} className='w-full h-full rounded-full object-cover' sizes=' (max-width: 768px) 100vw, (max-width: 1024px) 100vw, 1024px' /> : <Image src='/assets/icons/user.svg' alt='profile' width={0} height={0} className='rounded-full w-full h-full ' />}
        </div>
